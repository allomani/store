...
//==========================================================================
    ...
    if ($settings['online_members_count']) {
        $data = members::db_qr_fetch("select count(*) as count from {{store_clients}} where ::last_login >= ':last_login'", array('last_login' => members::get_date($timeout, 'member_last_login')));
