			...
			img.onload = function () {
				...
				function start(e) {
					...
					.fadeTo($.support.opacity ? settings.duration : 0, 1); 
                     $(img).removeClass('cursor_zoomin');
                      $(img).addClass('cursor_zoomout');
                      
                    $(source).find('img:first').hide();
				}
				...
				function stop() {
					...
					.fadeTo(settings.duration, 0);
                     $(img).addClass('cursor_zoomin');
                      $(img).removeClass('cursor_zoomout');
                      
                      $(source).find('img:first').show();
				}
