...
<table width=100%>";
print "<tr><td width=24><img src='images/orders.gif' width=24></td><td class=row_1><a href='index.php?action=orders'>$phrases[the_orders]</a></td></tr>";
print "<tr><td width=24><img src='images/orders_status.gif' width=24></td><td class=row_2><a href='index.php?action=orders_status'>$phrases[orders_status]</a></td></tr>";
...
<table width=100%>";
print "<tr><td width=24><img src='images/products.gif' width=24></td><td class=row_1><a href='index.php?action=products'>$phrases[the_products_and_cats]</a></td></tr>";

print "<tr><td width=24><img src='images/hot_items.gif' width=24></td><td class=row_2><a href='index.php?action=hot_items'>$phrases[hot_items]</a></td></tr>"; 


if(if_admin("store_fields",true)){ 
print "<tr><td width=24><img src='images/fields.gif' width=24></td><td class=row_1><a href='index.php?action=store_fields'>$phrases[products_fields]</a></td></tr>";
}
print "</table></fieldset>"; 
...
print "<tr><td width=24><img src='images/gateways.gif' width=24></td><td class=row_2><a href='index.php?action=payment_gateways'>$phrases[payment_gateways]</a></td></tr>";
