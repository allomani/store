...
while($data = db_fetch($qr)){
     ...
     print "</td><td align=left>".iif($data['active'],"<b>$phrases[default]</b>","<a href='index.php?action=vote_active&id=$data[id]'> $phrases[set_default] </a>")." - <a href='index.php?action=vote_edit&cat=$data[id]'>$phrases[edit_or_options]</a> - <a href='index.php?action=vote_del&id=$data[id]' onClick=\"return confirm('$phrases[are_you_sure]');\">$phrases[delete]</a> </td></tr>" ;
