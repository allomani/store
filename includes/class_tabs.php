...
class tabs {
	...
	function run(){
		if (count($this->tabs) > 0){
			...
			echo "}\n";
			echo "</script>\n";
            print "<div class=tab_container><table width=\"100%\"><tr><td width=100% align=center><table cellpadding=\"0\" cellspacing=\"0\"><tr>";
			foreach($this->tabs as $tabname => $tabcontent){
				$tabid = "tab_".$this->name."_$tabname";
				$contentid = "tabcontent_".$this->name."_$tabname";
				echo "<td><DIV CLASS='";
				...
				echo "' ID='$tabid' ";
				echo "onClick=\"tab_".$this->name."('$tabname');\">$tabname</DIV></td>\n";
			}
            print "</tr></table></td></tr></table></div>";
